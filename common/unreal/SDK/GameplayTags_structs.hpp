...
struct alignas(0x08) FTableRowBase_
{
public:
	uint8                                         Pad_0[0x8];                                        // 0x0000(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FTableRowBase_) == 0x000008, "Wrong alignment on FTableRowBase_");
static_assert(sizeof(FTableRowBase_) == 0x000008, "Wrong size on FTableRowBase_");
